...
import com.example.goout.Adapter.CommentAdapter;
import com.example.goout.Model.Comment;
        ...
        post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (addcomment.getText().toString().equals("")) {
                    Toast.makeText(CommentsActivity.this, "No puedes enviar un comentario vacío", Toast.LENGTH_SHORT).show();
                } else {
                    addComment();
                }
            }
